...
class CustomSidebarViewProvider {
    ...
    getHtmlContent(webview) {
        ...
        const dogWalk2Uri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "assets", "dog_walk2.png"));
        const dogWalkUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "assets", "dog_walk3.png"));
    ...
    <body>
      ...
      function updateFrame() {
          ...
          // Randomly decide to stop or start movingsss
